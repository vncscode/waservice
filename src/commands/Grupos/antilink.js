...
module.exports = createCommand({
    name: "antilink",
    params: "<-start> <-stop>",
    aliases: ["antiurl", 'antlnk'],
    isAdmin: true,
    menu: "grupos",
    desc: "AntiLink Protege seu Grupo Contra Links.",
    async run(int) {
        try {
            ...
            if (!query) {
                await sock.sendMessage(from, {
                    text: `${Config.get("name")}: Para utilizar esse comando, insira -start para Habilitar o Antilink ou -stop para desabilitalo.`
                }, messageOptions);
                return;
            }
            ...
            if (query.includes('-start')) {
                ...
                await sock.sendMessage(from, {
                    text: `${Config.get("name")}: Antilink ativado com sucesso para este grupo!`
                }, messageOptions);
                ...
                await saveConfig(fileconf);
                await sock.sendMessage(from, {
                    text: `${Config.get("name")}: Antilink desativado com sucesso para este grupo!`
                }, messageOptions);
            } else {
                await sock.sendMessage(from, {
